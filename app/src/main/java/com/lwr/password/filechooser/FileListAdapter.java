package com.lwr.password.filechooser;
/*
...
public class FileListAdapter extends BaseAdapter {
    ...
    private final static int ICON_FOLDER = R.drawable.ic_provider;
    private final static int ICON_FILE = R.drawable.ic_provider;
